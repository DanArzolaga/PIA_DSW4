...
if (!empty($_POST)) {
    ...
    if (empty($_POST['Descrip'])) {
        ...
        $result = 0;
        if (empty($id)) {
            $query = mysqli_query($conexion, "SELECT * FROM categoria WHERE Descrip = '$Descrip'");
            ...
            if ($result > 0) {
                ...
                $query_insert = mysqli_query($conexion, "INSERT INTO categoria(Descrip) values ('$Descrip')");
                if ($query_insert) {
            ...
            $sql_update = mysqli_query($conexion, "UPDATE categoria SET Descrip = '$Descrip' WHERE IdCategoria = $id");
            if ($sql_update) {
                $alert = '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                ...
                                while ($data = mysqli_fetch_assoc($query)) { ?>
                                    <tr>
                                        ...
                                        <td style="width: 200px;">
                                            <a href="#" onclick="editarCategoria(<?php echo $data['IdCategoria']; ?>)" class="btn btn-primary"><i class='fas fa-edit'></i></a>
